...
<html lang="en">
<head>
    <title>Romance Novel Writers | Romance Novel Writing Services</title>
    <!-- head -->
...
<div class="wrapper">
    ...
    <section class="sec1 innerBanner romanceBanner">
        <div class="container">
            <div class="row">
                <div class="col-md-7 bannertextLeft">
                    <div class="bannerTextInner">
                        ...
                        <p>
                            Is love in the air? Let us help you explore and flourish your tales of budding romances or
                            coming-of-age romance stories. Our romance writing services broaden the horizons of
                            feel-good
                            romantic stories that are suited perfectly for an audience that loves a little dose of love!
                        </p>
                        <div class="btnBanner">
            ...
            <div class="BannerFields">
                <form action="/mail.php" method="post">
                    ...
                    <input type="hidden" id="location" name="locationURL"
                           value="http://theuniversalwriters.com/romance-writing/"/>
            ...
            <div class="row">
                <div class="col-md-7 reliable-agencyLeft">
                    <div class="abtLeft">
                        ...
                        <p>
                            Finding professional writers for a niche can be a strenuous task; romance is a category that
                            is
                            built for readers that want to read stories that can move them through numerous emotions;
                            romance is a multi-faceted genre that takes you on a journey of grief, heartbreak,
                            connection,
                            distance, and most importantly the intimacy and warmth associated with romance. </p>
                ...
                <div class="col-md-5  reliable-agencyRight">
                    <img src="https://theuniversalwriters.com/assets/images/Romance.webp" alt="HandBook Images"/>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 ctaTitleLeft">
                    <span class="heading2 boldheading2">Is there some romance brewing? Let our romance writers draft your books! </span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 ghostTitleagency">
                    <span class="ghostTitleheading">Why Our Love Gurus Make <br> the Best Romance Novel Writers
                        </span>
                </div>
                        ...
                        <div class="col-md-12 whychooeIconBox">
                            ...
                            <div class="whychooeIconBoxInner">
                                ...
                                <div class="contentChoose">
                                    ...
                                    <p>
                                        Already have a story in mind? Let our expert romance novel writers take you on a
                                        creative journey of designing, drafting and editing your manuscript to
                                        international
                                        publishing standards! Our ghost book writers don’t just write books, and they
                                        help
                                        you share a piece of art that can be appreciated by many!
                                    </p>
                                </div>
                            </div>
