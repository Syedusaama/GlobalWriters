jQuery(function () {
    ...
    $(window).scroll(function(){
        ...
        if ($(window).scrollTop() >= 150) {
            ...
            // $(".logoMain a img").attr("src", "https://theuniversalwriters.com/assets/images/logo-color.webp");
        }
        else {
            $('header').removeClass('sticky-header');
            // $(".logoMain a img").attr("src", "https://theuniversalwriters.com/assets/images/logo.webp");
        }
    }
    });
